...
def run(path, result_path, test_data_path_dir, get_model_embedding_batch_size):
...
def main():
    ...
    # Call run function
    run(args.model_name_or_path, args.result_path, args.test_data_language_path_dir, args.embedding_batch_size)
